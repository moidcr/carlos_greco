...
/**
 * \file    test/phpunit/SalaryPrintFunctionalTest.php
 * \ingroup salaryprint
...
/**
 * Class SalaryPrintFunctionalTest
 *
 ...
 *
 * @package Testsalaryprint
 */
class SalaryPrintFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSalaryPrint')->click();
		} else {
			// Disable the module
			$this->byHref('modSalaryPrint')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/salaryprint/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('salaryprint/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/salaryprint/admin/about.php');
		$this->authenticate();
		return $this->assertContains('salaryprint/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('salaryprintwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSalaryPrint_SalaryPrintTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSalaryPrint_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
